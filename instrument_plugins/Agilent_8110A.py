# Agilent_81110A.py class, to perform the communication between the Wrapper and the device
...
class Agilent_81110(Instrument):
    '''
    This is the driver for the Agilent 81110 Signal Genarator

    Usage:
    Initialize with
    <name> = instruments.create('<name>', 'Agilent_81110', address='<GBIP address>, reset=<bool>')
    '''

    def __init__(self, name, address, reset=False):
        '''
        Initializes the Agilent_81110, and communicates with the wrapper.
        ...
        '''
        logging.info(__name__ + ' : Initializing instrument Agilent_81110')
        ...
        self.add_parameter('interval', flags=Instrument.FLAG_GETSET, units='ns', minval=2.849, maxval=10e9, type=types.FloatType)
